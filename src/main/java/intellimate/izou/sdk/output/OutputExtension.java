 ...
 */
public abstract class OutputExtension<T> implements intellimate.izou.output.OutputExtension<T> {
    ...
    /**
     * Adds an event to be expected when it is fired
     *
